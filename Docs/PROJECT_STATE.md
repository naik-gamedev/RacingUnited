...
1. Add a suspension component/provider graph for MacPherson, double-wishbone, trailing-arm, live-axle, leaf-spring, pushrod/pullrod and motorcycle layouts.
...
3. Move production chassis collision and mass-property descriptions into the compiled definition envelope.
