...
**Current candidate:** Step 29Q — Observable Terrain Contact Loss
...
milestone diagnoses but does not yet correct the
query-only triangle path; authoritative scalable mesh contact is next.
