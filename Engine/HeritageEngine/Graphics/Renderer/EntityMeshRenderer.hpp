...
private:
    ...
    struct UniformLocations
    {
        ...
        GLint tireRadialDeflectionM = -1;
        GLint tireContactPatchLengthM = -1;
        GLint tireContactPatchWidthM = -1;
        GLint tireRingRadialOffsetM = -1;
        GLint tireRingLongitudinalOffsetM = -1;
        GLint tireRingLateralOffsetM = -1;
        GLint tireRingYawDegrees = -1;
        GLint tireRingWindupDegrees = -1;
        GLint tireFlatSpotDepthM = -1;
        GLint tireFlatSpotSector = -1;
        GLint tireContactNormalWorld = -1;
        GLint tireWheelForwardWorld = -1;
        GLint tireWheelRightWorld = -1;
        GLint tireNormalForceN = -1;
        GLint tireLongitudinalForceN = -1;
        GLint tireLateralForceN = -1;
        GLint tireVisualMotionSpeedMps = -1;
        GLint tireContactPlaneDistanceM = -1;
        GLint tireVisualSupportGridValid = -1;
        GLint tireVisualSupportHalfLengthM = -1;
        GLint tireVisualSupportHalfWidthM = -1;
        GLint tireVisualSupportHeightResidualM = -1;
        GLint tireVisualProbeGridValid = -1;
        GLint tireVisualProbeCompressionM = -1;
        GLint tireProbeDebugVisible = -1;
        GLint tireVisualColliderTriangleCount = -1;
        GLint tireVisualColliderTriangleA = -1;
        GLint tireVisualColliderTriangleB = -1;
        GLint tireVisualColliderTriangleC = -1;
        GLint tireVisualColliderTriangleNormal = -1;
