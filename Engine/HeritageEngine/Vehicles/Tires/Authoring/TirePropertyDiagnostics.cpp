...
{
    // This list deliberately covers every assignment the current Heritage tire
    // importer consumes. Anything outside it remains visible as compatibility
    // diagnostics instead of being silently discarded or falsely claimed as an
    // active proprietary MF-Swift/T&V mechanism.
    const std::unordered_map<std::string, std::vector<std::string>> supported = {
        ...
        { "HERITAGE_THERMAL", { "ENABLED", "REFERENCE_TEMP_C", "INITIAL_TREAD_C", "INITIAL_BELT_C", "INITIAL_CARCASS_C", "INITIAL_INNER_SIDEWALL_C", "INITIAL_OUTER_SIDEWALL_C", "INITIAL_GAS_C", "INITIAL_RIM_C", "AMBIENT_TEMP_C", "ROAD_TEMP_C", "AMBIENT_PRESSURE_PA", "TREAD_CAPACITY_JPK", "BELT_CAPACITY_JPK", "CARCASS_CAPACITY_JPK", "INNER_SIDEWALL_CAPACITY_JPK", "OUTER_SIDEWALL_CAPACITY_JPK", "GAS_CAPACITY_JPK", "RIM_CAPACITY_JPK", "K_TREAD_BELT_WPK", "K_TREAD_CARCASS_WPK", "K_BELT_CARCASS_WPK", "K_CARCASS_INNER_SIDEWALL_WPK", "K_CARCASS_OUTER_SIDEWALL_WPK", "K_TREAD_ROAD_WPK", "K_TREAD_AIR_WPK", "K_CARCASS_AIR_WPK", "K_INNER_SIDEWALL_AIR_WPK", "K_OUTER_SIDEWALL_AIR_WPK", "K_CARCASS_GAS_WPK", "K_INNER_SIDEWALL_GAS_WPK", "K_OUTER_SIDEWALL_GAS_WPK", "K_GAS_AMBIENT_WPK", "K_CARCASS_RIM_WPK", "K_INNER_SIDEWALL_RIM_WPK", "K_OUTER_SIDEWALL_RIM_WPK", "K_RIM_AIR_WPK", "K_TREAD_AIR_SPEED", "K_CARCASS_AIR_SPEED", "K_SIDEWALL_AIR_SPEED", "K_RIM_AIR_SPEED", "SLIP_HEAT_TREAD_FRACTION", "SLIP_HEAT_BELT_FRACTION", "SLIP_HEAT_EFFICIENCY", "CARCASS_LOSS_EFFICIENCY", "CARCASS_LOSS_BELT_FRACTION", "SIDEWALL_FLEX_HEAT_FRACTION", "BRAKE_HEAT_TO_RIM_FRACTION", "OPTIMUM_TREAD_C", "COLD_SPAN_C", "HOT_SPAN_C", "MAX_COLD_GRIP_LOSS", "MAX_HOT_GRIP_LOSS", "MIN_FRICTION_SCALE", "MAX_FRICTION_SCALE", "STIFFNESS_TEMP_SLOPE", "MIN_STIFFNESS_SCALE", "MAX_STIFFNESS_SCALE" } },
        { "HERITAGE_DAMAGE", { "ENABLED", "DISCHARGE_COEFFICIENT", "SLOW_PUNCTURE_AREA_M2", "RAPID_LOSS_AREA_M2", "BLOWOUT_AREA_M2", "TREAD_CUT_AREA_M2", "SIDEWALL_CUT_AREA_M2", "VALVE_LEAK_AREA_M2", "BEAD_LEAK_AREA_M2", "UNDERINFLATION_DAMAGE_START_RATIO", "COLLAPSED_PRESSURE_RATIO", "COLLAPSE_LOADED_DELAY_S", "MAX_SAFE_CARCASS_TEMP_C", "BELT_FATIGUE_REFERENCE_J", "CORD_FATIGUE_REFERENCE_J", "SIDEWALL_FATIGUE_REFERENCE_J", "FATIGUE_HEAT_ACCEL_PER_C", "FATIGUE_OVERLOAD_EXPONENT", "GRAINING_COLD_BELOW_OPTIMUM_C", "GRAINING_BUILD_PER_KJ", "GRAINING_RECOVERY_PER_S", "BLISTER_TEMP_C", "BLISTER_BUILD_PER_KJ", "BLISTER_RECOVERY_PER_S", "DELAMINATION_TEMP_C", "DELAMINATION_BUILD_PER_S", "BEAD_UNSEAT_PRESSURE_RATIO", "BEAD_UNSEAT_LATERAL_FORCE_RATIO", "BEAD_DAMAGE_PER_S", "RIM_DAMAGE_POWER_THRESHOLD_W", "RIM_DAMAGE_PER_S", "RUNFLAT_ENABLED", "RUNFLAT_LOAD_FRACTION", "RUNFLAT_MAX_SPEED_MPS", "RUNFLAT_MAX_TEMP_C", "RUNFLAT_HEALTH_LOSS_PER_S" } },
