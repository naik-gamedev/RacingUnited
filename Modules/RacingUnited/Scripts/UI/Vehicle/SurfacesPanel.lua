...
function DrawVehicleSurfacesPanel()
    ...
    UI.TextWrapped("Each suspension ray reads the material and wetness from the exact collider beneath that tire. Different tires may contact different surfaces simultaneously. Scene rain and hydrology now live under SCENE -> WEATHER.")
    UI.Spacing()
